...
const EmployeeRegistrationIndex = () => {
  ...
  const updateClick = () => {
    ...
    if (!nullChk(email)) {
      ...
      errMsg.push("Please fill your email in Email Format");
    }

    if (!nullChk(fromDate)) {
      errMsg.push("Please select Date of Birth");
    }
    ...
    if (selectEng == "") {
      errMsg.push("Please select your English Skill");
    }

    if (selectJapan == "") {
      errMsg.push("Please select your Japanese Skill");
    }

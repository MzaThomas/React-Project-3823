...
const LoginForm = (props) => {
  let { zoomSize, loginClick, keyDownHandler, passwordChange, password, userCodeChange, userCode, success, error
  } = props;
  return (
    <>
      {zoomSize < 150 && (
      ...
      {zoomSize > 149 && (
        ...
        <div className="login-bg-mobile">
          <br></br>
          <br></br>
          <h2 style={{ textAlign: "center", fontWeight: "600", color: "#FEEC72" }}>
            Registration System
          </h2>
          ...
          >
            ...
            <CCol lg="6">
              ...
              <CInput type="text" value={userCode}
                ...
                className="input-field-blue-background" onChange={userCodeChange} />
              <br></br>
              <label
                style={{
                  fontWeight: "550",
